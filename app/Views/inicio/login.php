        ...
        <div class="row">
            ...
            <div class="col-md-4 col-md-4 col-sm-4 col-xs-12">
                <div class="text-center m-b-md custom-login">
                    <h3 class="text-white" >Login|SIGES</h3>
                ...
                <div class="hpanel">
                    ...
                    <?=form_open(base_url('authcontroller/autenticar'))?>
                            <div class="form-group">
                                <label class="control-label" for="username">Seu email</label>
                                ...
                                <span class="help-block small">Seu email Unico email para Agenda Festa</span>
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="password">Senha</label>
                                <input type="password" title="Please enter your password" placeholder="******" required="" value="" name="senha" id="senha" class="form-control">
                                <span class="help-block small">Senha</span>
                            </div>
                            <div class="form-group col-lg-12">
                        <select class="form-control required" name="tipo_de_acesso" required>
                            ...
                            <input type="submit" class="btn btn-success btn-block loginbtn"> 
                            <a class="btn btn-default btn-block" href="<?php echo base_url('inscreverse')?>">Regitrar-se</a>
                            <?=form_close()?>
                    </div>
                </div>
            </div>
