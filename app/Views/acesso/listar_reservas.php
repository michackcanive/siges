                        ...
                        <div class="product-status-wrap">
                            ...
                            <table>
                                ...
                                <?php 
                                    ...
                                    ?>
                                    <td>
                                    <button class="pd-setting" onclick="peguntar_apagar('<?=$dado_um['id']?>','<?=$dado_um['nome_salao']?>')"  ><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Pagar</font></font></button>
                                </td>
                                <?php }
