 ...
 * https://github.com/chart<?= base_url()?>/assets/js/Chart.<?= base_url()?>/assets/js/blob/master/LICENSE.md
 */
		...
		update: function(reset) {
			...
			if (showLine) {
				...
				line._model = {
					...
					// to https://github.com/chart<?= base_url()?>/assets/js/Chart.<?= base_url()?>/assets/js/issues/2435#issuecomment-216718158
	...
	helpers.extend(Chart.prototype, /** @lends Chart */ {
		...
		construct: function(item, config) {
			...
			if (!context || !canvas) {
				...
				// https://github.com/chart<?= base_url()?>/assets/js/Chart.<?= base_url()?>/assets/js/issues/2807
		...
		*/
		...
		render: function(duration, lazy) {
			...
			if (animationOptions && ((typeof duration !== 'undefined' && duration !== 0) || (typeof duration === 'undefined' && animationOptions.duration !== 0))) {
				...
				// See https://github.com/chart<?= base_url()?>/assets/js/Chart.<?= base_url()?>/assets/js/issues/3781
		...
		bindEvents: function() {
			...
			// See https://github.com/chart<?= base_url()?>/assets/js/Chart.<?= base_url()?>/assets/js/issues/2210
			if (me.options.responsive) {
				listener = function() {
					me.resize();
				};
...
module.exports = function(Chart) {
	...
	helpers.retinaScale = function(chart) {
		...
		// See https://github.com/chart<?= base_url()?>/assets/js/Chart.<?= base_url()?>/assets/js/issues/3575
...
module.exports = function(Chart) {
	 ...
	 * @see https://developer.mozilla.org/en-US/docs/Web/<?= base_url()?>/assets/css/used_value
	...
	function initCanvas(canvas, config) {
		...
		// https://github.com/chart<?= base_url()?>/assets/js/Chart.<?= base_url()?>/assets/js/issues/2538
	...
	function createResizer(handler) {
		...
		// https://github.com/chart<?= base_url()?>/assets/js/Chart.<?= base_url()?>/assets/js/issues/3090
		iframe.tabIndex = -1;

		// If the iframe is re-attached to the DOM, the resize listener is removed because the
		// content is reloaded, so make sure to install the handler after the iframe is loaded.
		// https://github.com/chart<?= base_url()?>/assets/js/Chart.<?= base_url()?>/assets/js/issues/3521
	...
	return {
		acquireContext: function(item, config) {
			...
			// https://github.com/chart<?= base_url()?>/assets/js/Chart.<?= base_url()?>/assets/js/issues/3887
			// https://github.com/chart<?= base_url()?>/assets/js/Chart.<?= base_url()?>/assets/js/issues/4102
			// https://github.com/chart<?= base_url()?>/assets/js/Chart.<?= base_url()?>/assets/js/issues/4152
...
module.exports = function(Chart) {
	 ...
	 * @see https://github.com/chart<?= base_url()?>/assets/js/Chart.<?= base_url()?>/assets/js/issues/2380#issuecomment-279961569
	 * @see https://github.com/chart<?= base_url()?>/assets/js/Chart.<?= base_url()?>/assets/js/issues/2440#issuecomment-256461897
	 */
